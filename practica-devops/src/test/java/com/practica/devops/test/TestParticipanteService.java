...
public class TestParticipanteService {
	...
	private static final String NOMBRE = "Santi Pruebas";
	private static final long ID2 = 1234567L;
	private static final String NOMBRE2 = "Monica Pruebas";
	...
	public void obtenerTodosTest() {
		...
		Mockito.when(participanteService.obtenerTodos())
				.thenReturn(Stream.of(new Participante(ID, NOMBRE, ESTADO), new Participante(ID2, NOMBRE2, ESTADO))
	...
	public void crearParticipanteTest() {
		...
		Mockito.when(participanteService.crearParticipante(participanteSave))
				.thenReturn(new Participante(ID, NOMBRE, ESTADO));
