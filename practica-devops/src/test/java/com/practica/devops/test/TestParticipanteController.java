...
public class TestParticipanteController {
	...
	public void obtenerTodosParticipantesControllerTest() throws Exception {
		mockMvcCliente.perform(MockMvcRequestBuilders.get("/devops/participantes").accept(MediaType.APPLICATION_JSON))
	...
	public void obtenerParticipanteIdControllerTest() throws Exception {
		mockMvcCliente
				.perform(MockMvcRequestBuilders.get("/devops/participantes/123456").accept(MediaType.APPLICATION_JSON))
				.andExpect(MockMvcResultMatchers.status().isOk());
	}
	...
	public void crearParticipanteControllerTest() throws Exception {
		...
		mockMvcCliente
				.perform(MockMvcRequestBuilders.post("/devops/participantes").contentType(MediaType.APPLICATION_JSON)
	...
	public void eliminarParticipanteIdControllerTest() throws Exception {
		mockMvcCliente.perform(
				MockMvcRequestBuilders.delete("/devops/participantes/123456").accept(MediaType.APPLICATION_JSON))
				.andExpect(MockMvcResultMatchers.status().isOk());
	}
}
